...
function App() {
    const { state, isRunning, fps, recoveryMode, setTorque, setDisturbance, resetState, startSimulation, stopSimulation, } = useGimbal();
    return (_jsxs("div", { className: "app-container", children: [_jsxs("div", { className: "viewer-container", children: [_jsxs("div", { className: "status-indicator", children: [_jsx("div", { className: `status-dot ${isRunning ? '' : 'stopped'}` }), _jsx("span", { children: recoveryMode ? '保护恢复中...' : isRunning ? '运行中' : '已停止' })] }), _jsxs("div", { className: "fps-counter", children: [fps, " FPS"] }), recoveryMode && (_jsx("div", { style: {
                        ...
                        }, children: "\u26A0\uFE0F \u5947\u5F02\u70B9\u4FDD\u62A4\uFF1A\u81EA\u52A8\u6062\u590D\u4E2D" })), _jsx(GimbalViewer, { state: state })] }), _jsx(ControlPanel, { state: state, isRunning: isRunning, onSetTorque: setTorque, onSetDisturbance: setDisturbance, onReset: resetState, onStart: startSimulation, onStop: stopSimulation })] }));
}
export default App;
